...
function Datepicker() {
	...
	this.dpDiv = bindHover($('<div id="' + this._mainDivId + '" class="jq-ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>'));
}
...
$.extend(Datepicker.prototype, {
	...
	_newInst: function(target, inline) {
		...
		return {id: id, input: target, // associated target
			...
			bindHover($('<div class="' + this._inlineClass + ' jq-ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all"></div>')))};
	},
	...
	_generateHTML: function(inst) {
		...
		for (var row = 0; row < numMonths[0]; row++) {
			...
			for (var col = 0; col < numMonths[1]; col++) {
				...
				calender += '<div class="jq-ui-datepicker-header ui-widget-header ui-helper-clearfix' + cornerClass + '">' +
